...
SonadoraTurbidity = SonadoraTurbidity.drop(columns=['censorcodecv_id', 'qualitycodecv_id'])

print(SonadoraDischarge.head())
print(SonadoraSP.head())
print(SonadoraTurbidity.head())
quit()
```
...
hysdict = hysteresisMetrics(SonadoraDischarge,SonadoraSP, timespacing, timespacing, debug=False, interpall=True, discharge_time_spacing_units='minutes', response_time_spacing_units='minutes', )
